# Test the sub-chain search results urls
from utilities import to_obj
from chain_3_1 import search_results_urls_chain
...
result_urls_list = search_results_urls_chain.invoke(web_search_dict)
